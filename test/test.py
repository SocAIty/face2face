...
def test_multi_face_from_reference():
    ...
    f2f.add_reference_face("hagrid", f1, save=True)
    f2f.add_reference_face("ron", f2, save=True)
    f2f.add_reference_face("biden", f3, save=True)
    f2f.add_reference_face("trump", f4, save=True)


    test_multi_face_img = "test_imgs/test_multi_swap_from_reference.jpg"
    swapped = f2f.swap_known_faces_to_target_faces(test_multi_face_img, swap_pairs={
        "trump": "hagrid",
        "biden": "ron"
    })
